...
class ArticleController extends Controller
{
    ...
    public function create(){
        ...
        $languages = Language::orderBy('id','ASC')->first();
        //dd($languages);
    ...
    public function language($id){
        $categories = Language::find($id)->categories()->where('parent_id','=',NULL)->get();
    ...
    public function store(Request $request){
        ...
        if($user->name == 'admin' || $user->name == 'moderator' || $user->name == 'author')
        {
