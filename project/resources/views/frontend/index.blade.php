...
@section('contents')
    @if(isset($header_post->status) && $header_post->status == 1)
        <div class="mt-3 mb-3" style="background:{{ $header_post->bg_color }}">
            <div class="container custom-container">
                <div class="row custom-row">
                    <div class="col-md-6 col-lg-6 custom-padding">
                        <h3>{{ $header_post->title}}</h3>
                        <p> {{ $header_post->description }}</p>
                    </div>
                    <div class="col-md-6 col-lg-6 custom-padding text-right">
                        @if($header_post->post_date != '')
                            <h5> তারিখ  : {{ $header_post->post_date}}</h5>
                            <a class="btn btn-secondary" href="{{ route('frontend.category',$header_post->slug)}}">View More</a>
                        @endif
                    </div>
                    @foreach($header_news as $row)
                        <div class="col-md-6 col-lg-3 custom-padding">
                            <ul class="feature-news-ul">


                                <li><a href="{{ route('frontend.details',[$row->post_id,$row->slug])}}">
                                        <div class="feature-news-single">
                                            <div class="feature-news-left">
                                                <img src="{{asset('assets/images/post/'.$row->image_big)}}"
                                                     class="img-fluid" alt="{{ $row->post_title}}" title="{{ $row->post_title}}"/>
                                            </div>
                    ...
                    <ul class="marquee">
                        @if ($is_trendings->count()>0)
                            @foreach($is_trendings as $is_trending)
                                <li>
                                    <a href="{{ route('frontend.details',[$is_trending->id,$is_trending->slug])}}"><span><img
                                                class="img-fluid"
                                                src="{{asset('assets/images/'.$gs->favicon)}}"></span> {{$is_trending->title}}
                                    </a></li>
                            @endforeach
                        @else
                            <li><a href="#"><span><img class="img-fluid" src="{{asset('assets/images/'.$gs->favicon)}}"></span>এই
                                    মুহূর্তে কোন ব্রেকিং নিউজ নেই, দয়া করে নিউজ পোস্ট করুন।</a></li>
                    @endif
                </div><!--/.marquee-block-->
            </div><!--/.col-md-12-->
        </div><!--/.row-->
    ...
    @if(isset($hot_news->hot_news) && $hot_news->hot_news == 1)
        <div class="feature-news-wrapper bg-white">
            <div class="container custom-container">
                <div class="row custom-row">
                    @php
                        $hot_news_big_post=DB::table('posts')->where('is_trending',1)->orderBy('id','DESC')->limit(1)->get();
                        $hot_news_left_post = DB::table('posts as p1')
                                                ->select('p1.*')
                                                ->where('p1.is_feature', 1)
                                                ->whereRaw('p1.updated_at = (
                                                    SELECT MAX(p2.updated_at)
                                                    FROM posts p2
                                                    WHERE p2.feature_serial = p1.feature_serial
                                                    AND p2.is_feature = 1
                                                )')
                                                ->orderBy('p1.feature_serial', 'asc')  // order by feature_serial now
                                                ->limit(5)
                                                ->get();
                        $hot_news_right_post = DB::table('posts')->where('is_trending', 0)
                        ->where('is_feature', 0)
                        ->orderBy('id', 'DESC')
                        ->limit(5)
                        ->get();
                    ...
                    <div class="col-md-6 col-lg-6 custom-padding">
                        ...
                        @foreach ($hot_news_big_post as $row)
                    ...
                    <div class="col-md-6 col-lg-3 custom-padding">
                        <ul class="feature-news-ul">
                            ...
                            @foreach($hot_news_left_post as $row)
                                <li><a href="{{ route('frontend.details',[$row->id,$row->slug])}}">
                                        <div class="feature-news-single">
                                            <div class="feature-news-left">
                                                <img src="{{asset('assets/images/post/'.$row->image_big)}}"
                                                     class="img-fluid" alt="{{ $row->title}}" title="{{ $row->title}}"/>
                                            </div>
                                            <div class="feature-news-right">
                    ...
                    <div class="col-md-6 col-lg-3 custom-padding">
                        ...
                        {{--<div class="special-event-heading mobile-heading tab-heading">
                            <h2 class="title"><a href="{{ URL::to("$fourthcat->slug")}}"><span
                                        class="text-span"> {{ $fourthcat->title ??''}}  </span></a><span
                                    class="liner"></span></h2>
                        </div><!--/.special-event-heading-->--}}
                        <ul class="feature-news-ul">


                            @foreach($hot_news_right_post as $row)
                                <li><a href="{{ route('frontend.details',[$row->id,$row->slug])}}">
                                        <div class="feature-news-single">
                                            <div class="feature-news-left">
                                                <img src="{{asset('assets/images/post/'.$row->image_big)}}"
...
<!-- DC-new-Ads Section 1-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_three_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_three_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
<!-- DC-new-Ads Section 1-->
                            ...
                            <div class="col-md-8 custom-padding">
                                <div class="lead-news">
                                    <a href="{{ route('frontend.details',[$slider->id,$slider->slug])}}">
                                        <img src="{{asset('assets/images/post/'.$slider->image_big)}}" class="img-fluid"
                                    ...
                                    <div class="lead-news-small-wrapper">
                                        <div class="lead-news-small">
                                            <a href="{{ route('frontend.details',[$slider_rights_first->id,$slider_rights_first->slug])}}">
                                                <img
                                                    src="{{asset('assets/images/post/'.$slider_rights_first->image_big)}}"
                                                    class="img-fluid" alt="{{$slider_rights_first->title}}"
                                                    title="{{$slider_rights_first->title}}"/>
                            ...
                            <div class="col-md-4 custom-padding">
                                <div class="lead-news-second">
                                    <a href="{{ route('frontend.details',[$slider_rights_second->id,$slider_rights_second->slug])}}">
                                        <img src="{{asset('assets/images/post/'.$slider_rights_second->image_big)}}"
                                             class="img-fluid" alt="{{$slider_rights_first->title}}"
                                             title="{{$slider_rights_first->title}}"/>
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <div class="least-news">
                                <ul class="least-news-ul">
                                    @php
                                        $latestpost=DB::table('posts')->orderBy('id','ASC')->limit(20)->get();
                                    @endphp
        ...
        <div class="container custom-container">
            <div class="row custom-row">
                @php
                    ...
                    $firstcatpostbig=DB::table('posts')->where('category_id',$firstcat->id)->where('is_feature',1)->orderBy('id','DESC')->take(1)->get();
                    $firstcatpostsmall=DB::table('posts')->where('category_id',$firstcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                @endphp
                <div class="col-md-6 col-lg-4 custom-padding">
                    <div class="special-event-heading">
                        <h2 class="title"><a href="{{ URL::to("$firstcat->slug")}}"><span
                                    class="text-span">{{ $firstcat->title ??''}}</span></a><span class="liner"></span>
                        </h2>
                    </div><!--/.special-event-heading-->
                ...
                <div class="col-md-6 col-lg-4 custom-padding">
                    @php
                        ...
                        $secondcatpostsmall=DB::table('posts')->where('category_id',$secondcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                    @endphp
                    <div class="special-event-heading mobile-heading">
                        <h2 class="title"><a href="{{ URL::to("$secondcat->slug")}}"><span
                                    class="text-span"> {{ $secondcat->title}} </span></a><span class="liner"></span>
                        </h2>
                    </div><!--/.special-event-heading-->
    ...
    <!-- DC-new-Ads Section 2-->
    <div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_two_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_two_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
        ...
        <div class="container custom-container">
            <div class="row custom-row">
                <div class="col-md-6 col-lg-4 custom-padding">
                    <div class="special-event-heading mobile-heading tab-heading">
                        @php
                            ...
                            $thirdcatpostsmall=DB::table('posts')->where('category_id',$thirdcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                        @endphp
                        <h2 class="title"><a href="{{ URL::to("$thirdcat->slug")}}"><span
                                    class="text-span">{{ $thirdcat->title}}</span></a><span class="liner"></span></h2>
                    </div><!--/.special-event-heading-->
                ...
                <div class="col-md-6 col-lg-4 custom-padding">
                    <div class="special-event-heading mobile-heading tab-heading">
                        @php
                            $thirdcat=DB::table('categories')->where('parent_id',null)->skip(5)->first();
                            $thirdcatpostbig=DB::table('posts')->where('category_id',$thirdcat->id)->where('is_feature',1)->orderBy('id','DESC')->limit(1)->get();
                            $thirdcatpostsmall=DB::table('posts')->where('category_id',$thirdcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                        @endphp
                        <h2 class="title"><a href="{{ URL::to("$thirdcat->slug")}}"><span
                ...
                <div class="col-md-6 col-lg-4 custom-padding">
                    @php
                        $fourthcat=DB::table('categories')->where('parent_id',null)->skip(7)->first();
                    ...
                    <div class="col-md-12 custom-padding">
                        <div class="special-event-heading">
                            @php
                                ...
                                $fifthcatpostsmall=DB::table('posts')->where('category_id',$fifthcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(5)->get();
                            @endphp
                            <h2 class="title"><a href="{{ URL::to("$fifthcat->slug")}}"><span
                                        class="text-span"> {{ $fifthcat->title ??''}} </span></a><span
                                    class="liner"></span></h2>
                        </div><!--/.special-event-heading-->
                    ...
                    <div class="col-md-12 custom-padding">
                        <div class="footer-facebook-like mt-2 mb-2">
                            ...
                            <div class="fb-page" data-href="https://www.facebook.com/{{$gs->facebookpage_id}}"
                                 data-tabs="timeline"
                                 data-width="418" data-height="500" data-small-header="false"
						...
						<div class="dc-ad sports-banner-1 text-center">
							{!!$gs->section_four_point_three_ads!!}
						</div>
                    </div><!--/.col-md-12-->
...
<!-- DC-new-Ads Section 4-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_four_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_four_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
            ...
            <div class="row custom-row">
                <div class="col-md-6 custom-padding col-lg-3">
                    @php
                        ...
                        $seventhcatpostsmall=DB::table('posts')->where('category_id',$seventhcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                    @endphp
                    <div class="special-event-heading">
                        <h2 class="title"><a href="{{ URL::to("$seventhcat->slug")}}"><span
                                    class="text-span"> {{ $seventhcat->title ??''}} </span></a><span
                                class="liner"></span></h2>
                    </div><!--/.special-event-heading-->
                ...
                <div class="col-md-6 col-lg-3 custom-padding">
                    @php
                        ...
                        $eighthcatpostsmall=DB::table('posts')->where('category_id',$eighthcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                    @endphp
                    <div class="special-event-heading mobile-heading">
                        <h2 class="title"><a href="{{ URL::to("$eighthcat->slug")}}"><span
                                    class="text-span">  {{ $eighthcat->title ??''}} </span></a><span
                                class="liner"></span></h2>
                    </div><!--/.special-event-heading-->
                ...
                <div class="col-md-6 col-lg-3 custom-padding">
                    @php
                        ...
                        $ninethcatpostsmall=DB::table('posts')->where('category_id',$ninethcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                    @endphp
                    <div class="special-event-heading mobile-heading tab-heading">
                        <h2 class="title"><a href="{{ URL::to("$ninethcat->slug")}}"><span
                                    class="text-span"> {{ $ninethcat->title ??''}} </span></a><span
                                class="liner"></span></h2>
                    </div><!--/.special-event-heading-->
                ...
                <div class="col-md-6 col-lg-3 custom-padding">
                    @php
                        ...
                        $tenthcatpostsmall=DB::table('posts')->where('category_id',$tenthcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                    @endphp
                    <div class="special-event-heading mobile-heading tab-heading">
                        <h2 class="title"><a href="{{ URL::to("$tenthcat->slug")}}"><span
                                    class="text-span"> {{ $tenthcat->title ??''}} </span></a><span class="liner"></span>
                        </h2>
                    </div><!--/.special-event-heading-->
...
<!-- DC-new-Ads Section 5-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_five_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_five_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
    ...
    <section class="sports">
        <div class="container custom-container">
            @php
                ...
                $eleventhcatpostsmall=DB::table('posts')->where('category_id',$eleventhcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(1)->limit(4)->get();
                $eleventhcatpostsmall2=DB::table('posts')->where('category_id',$eleventhcat->id)->where('is_feature',1)->orderBy('id','DESC')->skip(5)->limit(4)->get();
            @endphp
            <div class="row custom-row">
                <div class="sports-news-left">
                    <div class="col-md-12">
                        <div class="special-event-heading">
                            <h2 class="title"><a href="{{ URL::to("$eleventhcat->slug")}}"><span
                                        class="text-span"> {{ $eleventhcat->title ??''}} </span></a><span
                                    class="liner"></span></h2>
                        </div><!--/.special-event-heading-->
                ...
                <div class="sports-news-right">
                    <div class="col-md-12">
                        <div class="sports-banner-1 text-center">
                            {!!$gs->section_six_point_three_ads!!}
                        </div><!--/.sports-banner-1-->
...
<!-- DC-new-Ads Section 6-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_six_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_six_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
            ...
            <div class="row custom-row">
                <div class="life-style-left">
                    <div class="col-md-12 custom-padding">
                        ...
                        @endphp
                        <div class="special-event-heading">
                            <h2 class="title"><a href="{{ URL::to("$firstcat->slug")}}"><span class="text-span"> আলোচিত সংবাদ সমূহ </span></a><span
                                    class="liner"></span></h2>
                        </div><!--/.special-event-heading-->
                ...
                <div class="life-style-right">
                    <div class="col-md-12">
                        <div class="namaj-time">
                            ...
                            <div class="namaj-time-body">
                                <div class="namaj-time-body-left">
                                    <img class="img-fluid" src="{{asset('assets/frontend/namaj-time.jpg')}}"
                                         alt="Masjid">
                        ...
                        <div class="life-style-2 text-center">
                            {!!$gs->section_seven_point_three_ads!!}
                        </div><!--/.sports-banner-2-->
                    </div><!--/.col-md-12-->
...
<!-- DC-new-Ads Section 7-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_seven_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_seven_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
                        ...
                        <a href="{{ route('frontend.details',[$row->id,$row->slug])}}">
                            <div class="single-videos">
                                ...
                                <div class="videos-text">
                                    <h3>{{strlen($row->title)>40 ? mb_substr($row->title,0,40,"utf-8") : $row->title}}
                                        ...</h3>
                                </div>
                            </div>
                        </a>
...
<!-- DC-new-Ads Section 8-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_eight_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_eight_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
        ...
        <div class="container custom-container">
            <div class="row custom-row">
                <div class="international-news-left">
                    ...
                    <div class="col-md-12 custom-padding">
                        <div class="special-event-heading">
                            <h2 class="title"><a href="#"><span
                                        class="text-span"> সব থেকে বেশি জনপ্রিয় সংবাদ সমূহ </span></a><span
                                    class="liner"></span></h2>
                        </div><!--/.special-event-heading-->
                    ...
                    <div class="col-md-12 custom-padding">
                        ...
                        <div class="bangladesh-map">
                            ...
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 viewBox="-1183.849 0 1065.106 1391" enable-background="new -1183.849 0 1065.106 1391"
                                 xml:space="preserve">
<g id="Dhaka">
...
-546.134,661.709 -545.456,661.898 -546.133,661.709 "></polygon>
        <rect x="-501.047" y="578.667" fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" width="0"
              height="2.635"></rect>
                                ...
                                <g id="Khulna">
                                    <a href="{{$gs->khulna}}" xlink:href="{{$gs->khulna}}">
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-740.763,967.078 -740.763,967.076
...
-736.613,970.746 -739.895,969.009 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-913.866,1132.747 -918.694,1129.947
...
-916.667,1142.692 -910.391,1146.071 -907.881,1142.111 -909.039,1135.934 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-907.881,1142.113 -907.881,1142.111
...
-634.469,843.502 -633.406,846.785 -631.671,856.053 -629.931,854.991 -625.2,849.198 -622.014,846.012 -621.725,844.371 "></polygon>
                                <g id="Barishal">
                                    <a href="{{$gs->barishal}}" xlink:href="{{$gs->barishal}}">
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-605.798,1091.138 -605.798,1086.502
...
-610.139,1102.046 -608.402,1103.205 -606.375,1098.088 -603.094,1097.316 -604.25,1093.743 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-616.029,1069.607 -623.465,1076.077
...
-628.29,1070.38 -628.677,1075.689 -627.423,1075.689 -626.262,1073.373 -617.284,1068.063 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-555.496,980.304 -564.67,971.905
...
-651.557,1073.276 -654.744,1078.393 -657.447,1084.958 -658.701,1089.785 -657.447,1089.785 -655.998,1085.055 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-652.136,1084.668 -655.711,1088.724
...
-653.297,1097.316 -648.082,1088.434 -647.309,1083.51 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-597.492,986.291 -600.294,983.2
...
-594.5,997.104 -594.016,998.743 -591.699,1003.379 -592.182,998.068 -594.5,991.793 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-532.035,1035.913 -533.194,1037.361
...
-620.277,868.409 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-523.057,1020.178 -522.187,1015.543
...
-635.724,846.591 -636.484,847.748 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-640.165,1072.698 -642.868,1074.917
...
"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-615.548,906.738 -612.36,905.579
...
-750.131,932.901 -747.811,931.936 -745.784,932.709 -744.338,932.128 -745.784,932.707 "></polygon>
                                <g id="Chittagong">
                                    <a href="{{$gs->ctg}}" xlink:href="{{$gs->ctg}}">
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-318.77,1190.48 -318.288,1185.46
...
-334.509,1194.245 -330.452,1193.666 -325.238,1194.632 -320.604,1194.439 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-483.184,1019.694 -485.308,1011.585
...
-497.28,979.533 -493.032,982.235 -487.722,981.946 -483.474,980.016 -479.132,977.119 -477.102,971.905 -479.323,967.563 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-179.264,1236.436 -186.699,1213.652
...
-178.492,1240.973 	"></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-423.52,951.341 -427.865,953.658
...
C-529.053,422.632-529.205,422.351-529.566,422.149z"></path>
                                ...
                                <g id="Rajshahi">
                                    <a href="{{$gs->rajshahi}}" xlink:href="{{$gs->rajshahi}}">
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-765.286,595.673 -764.419,592.391
...
"></path>
                                ...
                                <g id="Rangpur">
                                    <a href="{{$gs->rangpur}}" xlink:href="{{$gs->rangpur}}">
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-766.155,245.605 -770.885,233.923
...
-764.03,254.68 "></polygon>
                                        <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                                 points="-777.839,310.869 -774.844,308.938
...
s9.535,4.269,9.535,9.536s-4.269,9.537-9.535,9.537S-869.445,850.269-869.445,845.001z"></path>
	...
	<!-- DC-new-Ads Section 9-->
<div class="dc-feature-news-wrapper bg-white">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_nine_point_one_ads!!}
			</div>
			<div class="col-md-6 col-lg-6 custom-padding">
				{!!$gs->section_nine_point_two_ads!!}
			</div>
		</div>
	</div>
</div>
                        ...
                        <div id="gallery-images-section" class="owl-carousel">
                            ...
                            @if ($image_albums->count()>0)
                                @foreach ($image_albums as $image_album)
                                    <li data-thumb="{{asset('assets/images/image-album/'.$image_album->photo)}}"
                                        style="list-style:none;">
                                        <img class="img-fluid"
                                             src="{{asset('assets/images/image-album/'.$image_album->photo)}}"/>
                                        <a class="photo-gallery-text"
                                           href="{{asset('assets/images/image-album/'.$image_album->photo)}}"><h3
                                                style="font-size:20px;">{{$image_album->album_name}}</h3></a>
                                    </li>
                                @endforeach
                            @else
                                ...
                                <li data-thumb="assets/images/nopic.png" style="list-style:none;">
                                    ...
                                    <a class="photo-gallery-text" href="#"><h3 style="font-size:20px;">এখানে কোন
                                            এ্যালবাম ইমেজস নেই</h3></a>
                                </li>
                            @endif
                                    ...
                                    @else
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                <div class="photo-gallery-ul-left">
                                                    <img class="img-fluid" src="assets/images/nopic.png"
                                                         alt="এখানে কোন এ্যালবাম ইমেজস নেই">
                                                </div>
                                                <div class="photo-gallery-ul-right">
