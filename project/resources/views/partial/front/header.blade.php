      ...
      <div class="row custom-row">
        <div class="col-md-6 custom-padding">
          <div class="date-area">
            ...
            <!--  <li><i class="las la-map-marker"></i> চট্টগ্রাম |</li>-->
            <!--    <span id="Clock"></span> বঙ্গাব্দ-->
            <!--</ul><!--/.date-area-->
            ই-পেপার  দেখতে <b> <a href="https://www.epaper.dainikgonojagoron.com/"> ক্লিক করুন </a></b>
          </div><!--/.date-area-->
        </div><!--/.col-md-5-->
        <div class="col-md-6 custom-padding">
      ...
      <div class="row custom-row">
        ...
        @if (Auth::guard('admin')->user() && Auth::guard('admin')->user()->role_id != 1)
            @php
                $data = Auth::guard('admin')->user();
            @endphp
            <a href="{{ route('admin.dashboard') }}" > <b>  সাংবাদিক প্যানেল </b></a>
        @endif
          <div class="main-logo">
...
<nav class="navbar navbar-expand-lg top-nav-sports">
    <div class="container navbar-container custom-container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="https://www.epaper.dainikgonojagoron.com" target="_blank" class="dc-epaper">  ই-পেপার </a></li>
