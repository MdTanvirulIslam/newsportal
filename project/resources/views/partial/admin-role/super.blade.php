...
<li>
    ...
    <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
        ...
        <li>
            <a href="{{route('admin.generalsettings.websiteContent')}}"><span><i class="fas fa-angle-double-right"></i>{{__('Website Setting')}}</span></a>
        </li>
        <li>
            <a href="{{route('admin.general-settings.adds')}}"><span><i class="fas fa-angle-double-right"></i>{{__('Adds')}}</span></a>
        </li>
        <li>
...
<li>
    <a href="https://m/me/official.elitedesign"><span><i class="fab fa-facebook-messenger"></i>{{ __('Our Facebook Page') }}</span></a>
</li>--}}
