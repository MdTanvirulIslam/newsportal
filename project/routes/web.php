...
Route::prefix('admin')->group(function(){
    ...
    Route::group(['middleware' => 'permissions:add_post'], function () {
        ...
        Route::post('/ckeditor/file-upload','Admin\ArticleController@upload_images')->name('ckeditor.image-upload');
        ...
        Route::view('/test-editor', 'admin.article.test-editor');
        Route::post('/test-editor', function (Illuminate\Http\Request $request) {
            dd($request->all());
        })->name('test-editor.submit');
   ...
   Route::group(['middleware' => 'permissions:posts'], function () {
    ...
    Route::group(['middleware' => 'permissions:general_settings'], function () {
        ...
        Route::get('/generalsettings/adds','Admin\GeneralSettingsController@adds')->name('admin.general-settings.adds');
        ...
        Route::get('/generalsettings/header-post','Admin\GeneralSettingsController@headerPost')->name('admin.generalsettings.headerPost');
        Route::post('/generalsettings/update-header-post','Admin\GeneralSettingsController@updateHeaderPost')->name('admin.generalsettings.updateHeaderPost');
...
Route::middleware(['check.domain'])->group(function () {
    ...
    Route::post('/post/click','Front\FrontendController@incrementClicks')->name('post.click');
});
